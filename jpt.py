...
# Создаем объект Fraction и присваиваем его переменным b и c
a = Fraction(1, 8)
b = c = Fraction(3, 8)  # Теперь b и c ссылаются на один и тот же объект

print(b is c)  # Вернет True

b -= a  # Изменяем b

print(a, b, c)  # Выводит: 1/8, 1/8 (b изменен), 3/8 (c остается тем же)
print(b is c)  # Вернет True, так как b и c ссылаются на один и тот же объект
print(343)
